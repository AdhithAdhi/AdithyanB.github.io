;jQuery(document).ready(function($){
	...
	if ( vendors ){
		$('head').append(
			...
			+'.card-tools a{display:inline-block;height:21px;color:#666;border:1px solid #ddd;border-radius:3px;padding:0 5px 0 18px;background: white url('+stats_png+') no-repeat}'
			+'.card-tools .watchers{border-right:1px solid #ddd}'
			+'.card-tools .forks{background-position:-4px -21px;padding-left:15px}'
