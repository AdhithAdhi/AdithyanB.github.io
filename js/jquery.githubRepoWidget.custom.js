;jQuery(document).ready(function($){
	...
	if ( vendors ){
		$('head').append(
			...
			+'.card .card-header .card-tools a{display:inline-block;height:21px;color:#666;border:1px solid #ddd;border-radius:3px;padding:0 5px 0 18px;background: white url('+stats_png+') no-repeat}'
			+'.card .card-header .card-tools .watchers{border-right:1px solid #ddd}'
			+'.card .card-header .card-tools .forks{background-position:-4px -21px;padding-left:15px}'
			...
			+'.card .card-footer .updated{word-wrap:break-word;margin:0;font-size:11px;color:#666;line-height:24px;font-weight:300;width:auto}'
			+'.card .card-footer .updated strong{font-weight:bold;color:#000}'
